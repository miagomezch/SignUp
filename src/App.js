...
import BackHeader from './Img/headerBanner.jpg';
                ...
                <div className="row">
                    ...
                    <div class="col-md-6">
                            <div class="control-group">
                              ...
                              <input name="SNombre" type="text" maxlength="50" id="txtMiddleName" title="Primer nombre" class="form-control" /> 
                              <span >&nbsp;&nbsp;&nbsp;</span>  
                            </div>
                    </div>                
                </div>
                ...
                <div className="row">
                    ...
                    <div class="col-md-6">
                            <div class="control-group">
                             ...
                             <input name="SApellido" type="text" maxlength="50" id="txtSecondLastName" title="Primer apellido" class="form-control" /> 
                             <span >&nbsp;&nbsp;&nbsp;</span> 
                            </div>
                    </div>                
                </div>
